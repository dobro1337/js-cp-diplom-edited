let days = Array.from(document.getElementsByClassName("page-nav__day")); // устанавливаем дату в списсок выше
let date = new Date();
...
pageNavDays.forEach((e,index) => {
  e.onclick = function () {
    ...
    setFilms(JSON.parse(localStorage.getItem("info")),selectDay);// функция из refreshFilm.js обновляем всю информацию под выбранную дату
  }
})